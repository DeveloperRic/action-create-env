...
exports.run = exports.writeToEnvFile = void 0;
const core_1 = __nccwpck_require__(186);
const dedent_1 = __importDefault(__nccwpck_require__(281));
const fs = __importStar(__nccwpck_require__(747));
const ENV_PREFIX = 'ACTION_CREATE_ENV_';
function getTextForEnvFile(args) {
    let text = dedent_1.default(args.full_text).trim();
...
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const args = {
                full_text: core_1.getInput('full_text'),
                directory: core_1.getInput('directory'),
                include_env_vars: !!core_1.getInput('include_env_vars')
            };
            core_1.info(`Creating .env file in ${args.directory}`);
            yield writeToEnvFile(args);
            core_1.info('Done.');
        }
        catch (error) {
